# [오류없는 자료를 만들려고 했지만, 혹시나 오탈자나 내용상 이상이 있는 부분이 있으면 아래의 예와 같이 해서 보내주시면 감사하겠습니다. ex. 고유번호 : math20190810001 자료의 ... 이 이상하여 ....으로 했으면 합니다.](https://open.kakao.com/o/stns33Pb) 
